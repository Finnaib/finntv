...
// "1672531200" = Jan 1, 2023. If empty, defaults to Dynamic.
    // AUTHENTICATED USERS (Generated by Admin Panel)
    $users_db = [
        "finn" => ["password" => "finn123", "created_at" => null, "max_connections" => 5, "exp_date" => null],
        "tabby" => ["password" => "tabby123", "created_at" => null, "max_connections" => 5, "exp_date" => null],
        "test" => ["password" => "test", "created_at" => null, "max_connections" => 5, "exp_date" => null],
        "shoaibwwe01@gmail.com" => ["password" => "Fatima786@", "created_at" => null, "max_connections" => 5, "exp_date" => null],
        "devz" => ["password" => "devz123", "created_at" => null, "max_connections" => 5, "exp_date" => null],
        "aayush787" => ["password" => "aayush@1091", "created_at" => null, "max_connections" => 5, "exp_date" => null],
    ];
