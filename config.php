...
function parseMoviesAndSeries()
{
    ...
    foreach ($files as $file) {
        ...
        // Optimization: only process specific files
        $lower_filename = strtolower($filename);
        if ($lower_filename !== 'live.m3u' && $lower_filename !== 'vod.m3u' && $lower_filename !== 'series.m3u') {
            continue; // Skip external/other files as requested
        }
