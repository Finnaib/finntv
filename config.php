...
// AUTHENTICATED USERS (Generated by Admin Panel)
$users_db = [
    "finnaib" => ["password" => "finnaib123", "created_at" => null, "max_connections" => 5, "exp_date" => null],
...
function parseMoviesAndSeries()
{
    ...
    foreach ($files as $file) {
        ...
        // Removed strict file filtering so custom lists like sport.m3u or fifa.m3u are parsed!
